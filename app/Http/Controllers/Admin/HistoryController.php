...
class HistoryController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($search->value != '' && $search->key && $search->filter) {
                ...
                if($search->key == 'player'){
                    // dd(1);
                    $query->with('player')->whereHas('player', function($q) use ($search_value){
