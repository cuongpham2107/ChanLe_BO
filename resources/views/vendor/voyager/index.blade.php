        ...
        <div class="analytics-container">
            <div class="clearfix container-fluid row">
                <div class="col-xs-12 col-sm-6 col-md-4"><div class="panel widget center bgimage" 
                    style="margin-bottom:0;overflow:hidden;background-image:url('https://adminvest.community-invest.net//storage/illustration-mobile-banking-phone-cartoon-flat_82574-6512.jpg');">
                    ...
                    <div class="panel-content">
                        ...
                        <a href="https://adminvest.community-invest.net/users" class="btn btn-primary">Tất cả users</a>
                    </div>
                </div>
                </div><div class="col-xs-12 col-sm-6 col-md-4"><div class="panel widget center bgimage" 
                    style="margin-bottom:0;overflow:hidden;background-image:url('https://adminvest.community-invest.net//storage/player.png');">
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        ...
                        <a href="https://adminvest.community-invest.net/players" class="btn btn-primary">Tất cả người chơi</a>
                    </div>
                </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="panel widget center bgimage" 
                    style="margin-bottom:0;overflow:hidden;background-image:url('https://adminvest.community-invest.net//storage/history.png');">
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        ...
                        <a href="https://adminvest.community-invest.net/histories" class="btn btn-primary">Tất cả giao dịch</a>
                    </div>
                </div>
                </div>
            </div>
