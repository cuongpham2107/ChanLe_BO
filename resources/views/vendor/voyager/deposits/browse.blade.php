        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#65a30d">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager::generic.close') }}"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-edit"></i> Xác nhận nạp tiền</h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="update_form" method="POST">
                        ...
                        <select id="select_xacnhan" style="float: left; margin-bottom:20px" class="form-control" name="type">
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.active_close', function (e) {
            $('#update_form')[0].action = '{{ route('voyager.deposits.update_status', '__id') }}'.replace('__id', $(this).data('id'));
